const AuthenticationResourceTH = {
  ...
  fail_password_expired: 'Your password is expired. Please change your password.',
  fail_suspended_account: 'This account is suspended. You are not allowed to sign in. Please contact the administrator.',
  fail_blocked_account: 'This account is blocked. You are not allowed to sign in. Please contact the administrator.',
